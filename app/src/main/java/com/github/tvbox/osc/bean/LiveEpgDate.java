...
public class LiveEpgDate {
    ...
    public String getDatePresented() { return datePresented; }
    public void setDatePresented(String datePresented) { this.datePresented = datePresented; }
    public Date getDateParamVal() { return dateParamVal; }
    public void setDateParamVal(Date dateParamVal) { this.dateParamVal = dateParamVal; }
